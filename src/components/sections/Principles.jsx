          ...
          {principles.map((principle, index) => (
            <InView key={principle} delay={index * 50} as="li">
              <InteractiveSurface intensity={5}>
                <div className="group flex h-full items-start gap-4 rounded-2xl border border-white/[0.06] bg-white/[0.02] p-5 transition-all duration-300 hover:border-indigo-500/25 hover:bg-indigo-500/10 hover:shadow-[0_0_28px_-14px_rgba(99,102,241,0.35)]">
                  ...
                  <span className="text-sm leading-relaxed text-zinc-300 sm:text-base">{principle}</span>
                </div>
              </InteractiveSurface>
            </InView>
          ))}
